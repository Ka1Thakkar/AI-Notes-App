...
export function Features() {
  ...
  return (
    <section id="features" className="lg:py-24 py-12 w-full flex items-center justify-center bg-linear-to-b from-primary/75 to-primary/50 via-primary/75 lg:min-h-screen">
